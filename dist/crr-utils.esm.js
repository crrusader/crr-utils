...
export { inBrowser, inWeex, weexPlatform, UA, isMobile, hasTouch, isIE, isIE9, isEdge, isAndroid, isIOS, isChrome, isIPhone, isPad, isWebApp, mousedown, mousemove, mouseup, hasOwnProperty, toStringType, isArrayLike, isArray, each, encode, decode, querystring, debounce, throttle, supportCss3, allowTransition, allowAnimation, getWindowWidth, getWindowHeight, getTypeArg, nextFrame, trim, privatePhone, repeat, padStart, padEnd, arrayToObj, toArrayData, formatDate, formatDateRange, stringToArray, getRandom, cookie, formatMoney, regExp, getMaxZindex, resizeInit, loadImage, downloadFile };
